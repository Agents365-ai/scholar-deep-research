...
[English](README.md) · **中文** · [📖 在线文档](https://agents365-ai.github.io/scholar-deep-research/zh.html)
...
| Skill | 定位 | 何时使用 |
|---|---|---|
| [semanticscholar-skill](https://github.com/Agents365-ai/semanticscholar-skill) | Semantic Scholar API 检索 | 需要快速检索,不需要完整结构化综述 |
| [asta-skill](https://github.com/Agents365-ai/asta-skill) | 同一语料,经 Ai2 Asta MCP | 宿主支持 MCP 且持有 Asta API key |
| [paper-fetch](https://github.com/Agents365-ai/paper-fetch) | DOI → PDF,7 源回退 | 已有 ID 需要拿到全文 |
| [zotero-research-assistant](https://github.com/Agents365-ai/zotero-research-assistant) | Zotero 文献库工作流 | 参考文献需要进 Zotero |
